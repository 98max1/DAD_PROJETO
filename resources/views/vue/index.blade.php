...
-->
    <router-link to="/register" v-show="this.$store.state.user.type=='manager'">Register Worker</router-link> #  
    <router-link to="/users" v-show="this.$store.state.user.type=='manager'">Users</router-link> # 
